...
// `WSD_FUSE_TRACE_FILE`) on SIGUSR2 and on unmount, or whenever an
...
const WRAPPED = Symbol("wsd.fuseTracerWrapped");
...
export interface FuseTracer {
  ...
  /** JSON summary suitable for stderr or `WSD_FUSE_TRACE_FILE`. */
